...
<head>
    ...
    <title>Fern Leaves Design | PJ</title>
    <!--bootstrap-->
...
<div class="header-title">
    ...
    <div class="main-container">
        <div class="image-product">
            <div class="image-banner">
                <img src="ring1a.png" alt="ring 1" id="img1">
                <img src="ring1b.png" alt="ring 2" class="jugad" id="img2">
                <img src="ring1c.png" alt="ring 3" class="jugad2" id="img3">
            </div>
            <div class="slideshow">
                <img src="ring1a.png" alt="ring 1" onclick="img1swap()">
                <img src="ring1b.png" alt="ring 2" onclick="img2swap()">
                <img src="ring1c.png" alt="ring 3" onclick="img3swap()">
            </div>
        </div>
        <div class="title-product">
            ...
            <div class="main-title">
                <span id="name">
                22 Karat Gold Finger Ring <br> In Fern Leaves Design
                </span><br>
                ...
                echo $final."rs";
                ?></p>
                <span style="font-size: 20px;">Size:&ensp; 17.20mm</span><br>
                <span style="font-size: 20px;">Weight:&ensp; 3.2g</span><br>
    ...
    if(isset($_POST['AddCart'])){
            $number=$_POST['quantity'];
                $sql = "INSERT INTO carttable (product , price, qua) VALUES ('22 Karat Gold Finger Ring In Fern Leaves Design' , '$final','$number')";
                try{
    ...
    <div class="specification-product">
        ...
        <table>
            <tr>
              <td class="right">PURITY&ensp;:-</td>
              <td class="right">22.00</td>
              <td class="left">PRODUCT&ensp;:-</td>
              <td class="left">Finger Ring</td>
            </tr>
            <tr>
              <td class="right">GENDER&ensp;:-</td>
              <td class="right">Women</td>
              <td class="left">JEWELLERY TYPE&ensp;:-</td>
              <td class="left">GOLD Jewellery</td>
            </tr>
            <tr>
              <td class="right">OCCASION&ensp;:-</td>
              <td class="right">CASUAL WEAR</td>
              <td class="left">METAL&ensp;:-</td>
              <td class="left">Gold</td>
            </tr>
            <tr>
              <td class="right">BRAND&ensp;:-</td>
              <td class="right">Parekh Jewellers</td>
              <td class="left">METAL COLOR&ensp;:-</td>
...
<!--get method to reach particular div and echo in javascript -->
</html>