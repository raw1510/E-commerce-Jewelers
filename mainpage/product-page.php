...
<head>
    ...
    <title>Chain Link Ring | PJ</title>
    <!--bootstrap-->
    ...
    <div class="main-container">
        <div class="image-product">
            <div class="image-banner">
                <img src="product(1).jpg" alt="ring 1" id="img1">
                <img src="product(2).jpg" alt="ring 2" class="jugad" id="img2">
                <img src="product(3).jpg" alt="ring 3" class="jugad2" id="img3">
            </div>
            <div class="slideshow">
                <img src="product(1).jpg" alt="ring 1" onclick="img1swap()">
                <img src="product(2).jpg" alt="ring 2" onclick="img2swap()">
                <img src="product(3).jpg" alt="ring 3" onclick="img3swap()">
            </div>
        </div>
        <div class="title-product">
            ...
            <div class="main-title">
                <span id="name">
                    Modern 22 Karat Gold <br> Chain Link Ring
                </span> <br> <br>
                ...
                <span>Quantity:-&ensp;</span><input type="number" name="quantity" value="1" id="quantity" min="1" max="5"><br>
            ...
            <?php
                    ...
                    if(isset($_POST['AddCart'])){
                            $number=$_POST['quantity'];
                                $sql = "INSERT INTO carttable (product , price, qua) VALUES ('Modern 22 Karat Gold Chain Link Ring' , '$final','$number')";
                                try{
    ...
    <div class="specification-product">
        ...
        <table>
            ...
            <tr>
              ...
              <td class="left">Traditional and Ethnic Wear</td>
            </tr>
            <tr>
